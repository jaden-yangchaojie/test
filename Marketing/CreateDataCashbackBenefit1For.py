...
# usageCount 必填
get_range_param_list=["01","02","03"]

for get_range in get_range_param_list:
    benefit_batch_no = "260417001001003333000000000000"+get_range
    benefit_name = '测试父子权益'
    start_time = "2026-02-21 00:00:00"
    ...
    crowd_no = "260417123456789101112000000000"+get_range
    crowd_rules = json.dumps(
        {"productCode": "STC002", "openDate": "2026-02-21T"+get_range+":00:00", "openEndDate": "2026-02-21T"+get_range+":59:59"})
    activity_no = "MK202602210000"+get_range
    #不改动##########
    ...
    preferential_rules = json.dumps({ "calculateMethod": "percent", "calculateParam": "0.07", "rewardChannel": "CASHBACK"})
    ...
    mk_bf_instance = (
                ...
                "('STMXFINCORE0','MXCC20220000','000000','" + benefit_batch_no + "','" + benefit_name + "','CASHBACK','ACTIVE','STC002','Credit','tester','tester','自动化测试勿动-返现权益化','2025-08-01 03:43:47','2025-08-01 09:43:47','2025-08-01 03:43:47','2025-08-01 09:43:47',null);")
    ...
    mk_activity = (
                ...
                "('STMXFINCORE0','MXCC20220000','" + activity_no + "','CASHBACK','BENEFIT权益测试','权益测试','ACTIVE',null,'"+activity_rules+"','','" + crowd_no + "','system','system','" + start_time_activity + "','" + end_time_activity + "','2025-08-19 22:01:50','2025-08-20 04:01:50','2025-08-19 22:01:50','2025-08-20 04:01:50',null,'STC002','CREDIT',null,null,null,'" + activity_no + "_audience',null,null);")
