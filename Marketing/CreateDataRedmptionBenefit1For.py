...
# usageCount 必填
get_range_param_list=["01","22","23"]

for get_range in get_range_param_list:
    benefit_batch_no = "251218001001003333000000000000"+get_range
    benefit_name = '自动化测试勿动-提现权益化'
    ...
    crowd_no = "251218123456789101112000000000"+get_range
    crowd_rules = json.dumps(
        {"productCode": "STC002", "openDate": "2025-04-21T"+get_range+":00:00", "openEndDate": "2025-04-21T"+get_range+":59:59"})
    activity_no = "MK202512180000"+get_range
    #不改动##########
    ...
    mk_bf_instance = (
                ...
                "('STMXFINCORE0','MXCC20220000','000000','" + benefit_batch_no + "','" + benefit_name + "','REDEMPTION','ACTIVE','STC002','Credit','tester','tester','自动化测试勿动-提现权益化','2025-08-01 03:43:47','2025-08-01 09:43:47','2025-08-01 03:43:47','2025-08-01 09:43:47',null);")
    ...
    mk_activity_task = (
                ...
                "('STMXFINCORE0','MXCC20220000','" + task_name + "','" + benefit_name + "','benefit Autotest','DEFAULT','','{}','" + activity_no + "','REDEMPTION','" + benefit_batch_no + "',null,'" + start_time + "','" + end_time + "','','','2025-08-18 20:40:57','2025-08-19 02:40:57','2025-08-18 20:40:57','2025-08-19 02:40:57');")
