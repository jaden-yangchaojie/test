...
if __name__ == '__main__':
    ...
    all_report_id="ca5f4eb7-1125-435d-8612-eabe8b54d35d"
    ...
    #查看单个用例情况
    get_tmp= \
        {'id': '45fbe04d-0199-4471-99ed-8cb0f3055e86', 'userId': 'admin', 'reportId': 'da924047-cea2-4508-b0b5-f58bce8c482d', 'name': '已出账还款（多笔多期）-多笔已出账&最小还款'}
    id=get_tmp["id"]
