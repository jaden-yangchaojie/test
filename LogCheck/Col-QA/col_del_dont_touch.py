    ...
    for get_one in output.split("\n"):
        if get_one.count("trading-")>0 or get_one.count("statement-")>0 or get_one.count("viewx-")>0:
            try:
                ...
                print(get_one)
                get_gramm=str.format('kubectl -n colombia exec -it {} rm logs/run/common-error.log',get_one)
                print (get_gramm)
                ...
                if get_one.count("statement-")>0:
                    get_gramm = str.format(
                        'kubectl -n colombia exec -it {} rm logs/credit-view/common-error.log', get_one)
                    print(get_gramm)
